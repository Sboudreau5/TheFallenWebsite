...
document.getElementById('andres-photo').addEventListener('click',
	function() {
...
document.getElementById('duncan-photo').addEventListener('click',
	function() {
...
document.getElementById('emma-photo').addEventListener('click',
	function() {
...
document.getElementById('andrew-photo').addEventListener('click',
	function() {
...
document.getElementById('phil-photo').addEventListener('click',
	function() {
